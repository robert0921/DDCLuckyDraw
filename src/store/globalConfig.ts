...
export const useGlobalConfig = defineStore('global', {
        ...
        return {
            globalConfig: {
                ...
                theme: {
                    ...
                    cardColor: 'rgb(254, 216, 53)',
                    cardWidth: 140,
                    cardHeight: 200,
                    textColor: '#00000000',
                    luckyCardColor: 'rgb(255, 215, 0)',
                    textSize: 30,
                    patternColor: 'rgb(26, 64, 201)',
                    patternList: [1,2,18,34,49,63,77,76,16,31,46,61,6,7,21,36,51,66,81,82,68,54,39,23,14,13,27,41,56,72,88,89] as number[],
                    background: {}, // 背景颜色或图片
                    font: '微软雅黑',
                    titleFont: '微软雅黑',
    ...
    getters: {
        ...
        getMusicVolume(state) {
            return state.globalConfig.musicVolume ?? 1
        },
    },
    actions: {
        // 设置全局配置
        ...
        setMusicVolume(volume: number) {
            this.globalConfig.musicVolume = Math.max(0, Math.min(1, volume))
        },
        // 重置所有配置
        reset() {
            this.globalConfig = {
